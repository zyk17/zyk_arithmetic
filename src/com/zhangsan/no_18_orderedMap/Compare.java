...
public class Compare {
	...
	public static void functionTest() {
		...
		Code01_AVLTreeMap.AVLTree<Integer, Integer> avl = new Code01_AVLTreeMap.AVLTree<>();
		Code02_SizeBalancedTree.SizeBalanced<Integer, Integer> sbt = new Code02_SizeBalancedTree.SizeBalanced<>();
	...
	public static void performanceTest() {
		...
		Code01_AVLTreeMap.AVLTree<Integer, Integer> avl;
		Code02_SizeBalancedTree.SizeBalanced<Integer, Integer> sbt;
		Code03_SkipListMap.SkipListMap<Integer, Integer> skip;
		long start;
		long end;
		int max = 1000000;
		treeMap = new TreeMap<>();
		avl = new Code01_AVLTreeMap.AVLTree<>();
		sbt = new Code02_SizeBalancedTree.SizeBalanced<>();
